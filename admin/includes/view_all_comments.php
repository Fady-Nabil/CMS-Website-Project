<table class="table table-bordered table-hover">
    ...
    while($row = mysqli_fetch_assoc($select_comments)) {
        ...
        echo "<tr>";
            ...
            echo "<td><a class='btn btn-danger btn-xs' href='comments.php?unapprove=$comment_id'>Unapprove</a></th>";
            echo "<td><a onClick=\"javascript: return confirm('Are you sure you want to delete?'); \" class='btn btn-danger btn-xs' href='comments.php?delete=$comment_id'>Delete</a></th>";
        echo "</tr>";
    }
    ?>
    </tbody>
