                    ...
                    <script type="text/javascript">
                        ...
                        function drawChart() {
                            ...
                            <?php
                               ...
                               $element_count = [$post_counts, $post_published_counts, $post_draft_counts, $comment_unapproved_counts, $comment_counts, $user_subscriber_counts, $user_counts, $categories_counts];
